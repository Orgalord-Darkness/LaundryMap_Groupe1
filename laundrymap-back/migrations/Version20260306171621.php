 ...
 */
final class Version20260306171621 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE administrateur (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(255) NOT NULL, mot_de_passe VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE laverie_equipement (id INT AUTO_INCREMENT NOT NULL, laverie_id INT NOT NULL, equipement_reference INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, capacite INT DEFAULT NULL, tarif DOUBLE PRECISION DEFAULT NULL, duree INT DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE laverie_fermeture (id INT AUTO_INCREMENT NOT NULL, laverie_id INT NOT NULL, jour VARCHAR(255) NOT NULL, date_ajout DATETIME NOT NULL, date_modification DATETIME NOT NULL, heure_debut TIME NOT NULL, heure_fin TIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE laverie_fermeture_exceptionnelle (id INT AUTO_INCREMENT NOT NULL, laverie_id INT NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, raison VARCHAR(255) DEFAULT NULL, date_ajout DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE laverie_historique_interaction (id INT AUTO_INCREMENT NOT NULL, action VARCHAR(50) NOT NULL, motif_action VARCHAR(255) DEFAULT NULL, date DATETIME NOT NULL, administrateur_id INT NOT NULL, laverie_id INT NOT NULL, INDEX IDX_D51587DF7EE5403C (administrateur_id), INDEX IDX_D51587DF97C840DF (laverie_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE laverie_note (id INT AUTO_INCREMENT NOT NULL, laverie_id INT NOT NULL, utilisateur_id INT NOT NULL, note SMALLINT NOT NULL, note_le DATETIME NOT NULL, commentaire VARCHAR(255) DEFAULT NULL, commentaire_le DATETIME DEFAULT NULL, reponse VARCHAR(255) DEFAULT NULL, repond_le DATETIME DEFAULT NULL, commentaire_supprime_motif VARCHAR(255) DEFAULT NULL, commentaire_supprime_le DATETIME DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE professionnel (id INT AUTO_INCREMENT NOT NULL, siren INT NOT NULL, statut VARCHAR(255) NOT NULL, date_validation DATETIME DEFAULT NULL, utilisateur_id_id INT NOT NULL, adresse_id_id INT NOT NULL, INDEX IDX_7A28C10FB981C689 (utilisateur_id_id), INDEX IDX_7A28C10F1004EF61 (adresse_id_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE laverie_media ADD CONSTRAINT FK_903A8D76EA9FDD75 FOREIGN KEY (media_id) REFERENCES media (id)');
