...
final class Version20260412073935 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE laverie_equipement ADD CONSTRAINT FK_17CAF8EE97C840DF FOREIGN KEY (laverie_id) REFERENCES laverie (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE laverie_fermeture ADD CONSTRAINT FK_2DA7259E97C840DF FOREIGN KEY (laverie_id) REFERENCES laverie (id) ON DELETE CASCADE');
