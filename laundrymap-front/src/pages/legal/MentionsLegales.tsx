      ...
      <div className="max-w-4xl mx-auto bg-card rounded-2xl shadow-sm p-8 md:p-12">
        ...
        <div className="space-y-10 text-foreground leading-relaxed">
          ...
          <section>
            ...
            <div className="bg-background rounded-xl p-5 space-y-1.5 text-sm">
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-4">3. Présentation du service</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-4">4. Propriété intellectuelle</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-4">5. Protection des données personnelles (RGPD)</h2>
            <p className="mb-3">
            ...
            <h3 className="text-base font-semibold text-foreground mt-5 mb-2">5.1 Responsable du traitement</h3>
            <p className="text-sm">EC2E – 4 boulevard Napoléon 1er, ZAC du Pont des Rayons, 95290 L'Isle-Adam – contact@ec2e.com</p>

            <h3 className="text-base font-semibold text-foreground mt-5 mb-2">5.2 Données collectées</h3>
            <p className="mb-2 text-sm">Selon le profil de l'utilisateur, les données suivantes peuvent être collectées :</p>
            <div className="space-y-3 text-sm">
              <div>
                <p className="font-medium text-foreground mb-1">Utilisateurs non connectés :</p>
              ...
              <div>
                <p className="font-medium text-foreground mb-1">Utilisateurs connectés (en plus des données ci-dessus) :</p>
                <ul className="list-disc list-inside pl-2 space-y-1">
              ...
              <div>
                <p className="font-medium text-foreground mb-1">Professionnels (gérants de laveries) :</p>
                <ul className="list-disc list-inside pl-2 space-y-1">
            ...
            <h3 className="text-base font-semibold text-foreground mt-5 mb-2">5.3 Finalités du traitement</h3>
            ...
            <h3 className="text-base font-semibold text-foreground mt-5 mb-2">5.4 Bases légales</h3>
            <ul className="list-disc list-inside space-y-1 text-sm pl-2">
            ...
            <h3 className="text-base font-semibold text-foreground mt-5 mb-2">5.5 Durée de conservation</h3>
            <ul className="list-disc list-inside space-y-1 text-sm pl-2">
            ...
            <h3 className="text-base font-semibold text-foreground mt-5 mb-2">5.6 Destinataires des données</h3>
            ...
            <h3 className="text-base font-semibold text-foreground mt-5 mb-2">5.7 Droits des utilisateurs</h3>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-4">6. Politique relative aux cookies</h2>
            <p className="mb-3">
            ...
            <h3 className="text-base font-semibold text-foreground mt-4 mb-2">6.1 Cookies strictement nécessaires (pas de consentement requis)</h3>
            <ul className="list-disc list-inside space-y-1 text-sm pl-2">
            ...
            <h3 className="text-base font-semibold text-foreground mt-4 mb-2">6.2 Cookies soumis à consentement</h3>
            <ul className="list-disc list-inside space-y-1 text-sm pl-2">
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-4">7. Sécurité des données</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-4">8. Liens hypertextes et services tiers</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-4">9. Limitation de responsabilité</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-4">11. Droit applicable et juridiction compétente</h2>
            <p>
          ...
          <section>
            ...
            <div className="bg-background rounded-xl p-5 text-sm space-y-1">
              <p className="font-semibold text-foreground">EC2E</p>
