...
function FicheLaverie() {
  ...
  const url = `${import.meta.env.VITE_API_BASE_URL}/api/v1/user/fiche-laverie/${id}`;
  ...
  return (
    ...
    <div className="flex flex-col items-center p-4 min-h-screen bg-gradient-to-b from-slate-900 to-slate-700 text-white">
      <div className="w-full max-w-5xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-lg border border-slate-100 shadow-sm p-4 w-full space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <a
              ...
              className="flex items-center justify-center gap-2 bg-slate-900 text-white py-3 px-4 rounded-2xl font-semibold text-sm active:scale-95 transition-transform shadow-md"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 bg-sky-400 text-white py-3 px-4 rounded-2xl font-semibold text-sm active:scale-95 transition-transform shadow-md"
            >
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-6">
          ...
          {/* Services */}
          <div className="border border-gray-300 shadow-sm rounded-md p-6 bg-white">
